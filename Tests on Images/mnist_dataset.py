...
def load_mnist_datasets(root, nums_keep=list(range(10)), normalize=True, extrap=False, max_train_size=None, max_test_size=None):
    ...
    numtest = len(test_data) // 2
    test_data = test_data[:numtest]
